...
func formModuleYAMLSchema() *yamlLintSchema {
	...
	for _, k := range []string{
		...
		"accesskey", "hotkey", "multiline", "format", "display_format", "type", "choice", "choice_dropdown", "editable_admin_only", "ref_card_button", "ref_card_button_admin_only", "unknown_xml", "view",
